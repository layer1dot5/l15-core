...
public:
    ...
    KeyRegistry(ChainMode chain, const std::string& seedhex): KeyRegistry(core::SchnorrKeyPair::GetStaticSecp256k1Context(), Bech32(BTC, chain), unhex<sensitive_bytevector>(seedhex)) {}
